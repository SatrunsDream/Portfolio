...
function displaySummary(data) {
  ...
  statsDiv.innerHTML = `
    <dl class="stats">
      <dt>Files</dt><dd>${numFiles}</dd>
      <dt>Total Lines</dt><dd>${totalLines}</dd>
      <dt>Total Length</dt><dd>${totalLength}</dd>
      <dt>Unique Authors</dt><dd>${uniqueAuthors}</dd>
    </dl>
  `;
}
...
function updateTooltipPosition(event) {
  ...
  if (y + tooltip.offsetHeight > window.innerHeight) {
    y = window.innerHeight - tooltip.offsetHeight - margin;
  }
